...
CREATE TABLE
  branch (
    ...
    branch_contact_number VARCHAR(15) branch_email VARCHAR(150) NOT NULL
  );
...
CREATE TABLE
  department_course (
    ...
    CONSTRAINT fk_department FOREIGN KEY (dep_id) REFERENCES staff (staff_id),
...
CREATE TABLE
  room (
    ...
    building_id INT,
    CONSTRAINT fk_building_id FOREIGN KEY (building_id) REFERENCES building (building_id) room_name VARCHAR(100) NOT NULL room_alt_name VARCHAR(100) NOT NULL,
